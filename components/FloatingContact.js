    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        <div className="flex flex-col gap-2 mb-1 animate-fade-in">
          ...
          {hasLine && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-3 bg-[#06C755] rounded-2xl shadow-lg px-5 py-3.5 hover:shadow-xl hover:bg-[#05b34d] transition group"
              title="LINE 線上諮詢"
            >
              ...
              <div className="text-white">
                <div className="text-sm font-bold">LINE 線上諮詢</div>
                <div className="text-xs text-white/80">立即與我們聊天</div>
              </div>
            </a>
          )}
      ...
      <button
        ...
        className={`w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 ${
          open ? 'bg-gray-700 rotate-45' : 'bg-[#06C755] hover:bg-[#05b34d]'
        }`}
        aria-label="聯絡我們"
      >
        {open ? (
